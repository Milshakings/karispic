...
KarisPic Sitio web para fanaticos de las fotos hechas por Kari con Ruby on Rails y Heroku

Web heroku: https://karispic-1d975e554c23.herokuapp.com/ 

Descripción Desarrollo de sitio de fotografias con seguridad y con bucket de Amazon en los que los Posts estarán en la pagina primaria, y se podrán agregar nuevos post o fotos solo inscribiendose en el sitio mediante la creación de un usuario. Modelo N a N.
